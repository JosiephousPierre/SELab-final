...
export default {
  ...
  methods: {
    checkAuth() {
      // Check if user is authenticated and has the Lab InCharge role
      ...
      try {
        ...
        // Verify the user has Lab InCharge role
        if (userData.role !== 'Lab InCharge') {
          console.error('User does not have Lab InCharge role');
