<template>
    <div class="sidebar" :class="{ expanded: isExpanded }" @mouseenter="expand" @mouseleave="collapse">
      ...
      <nav class="nav-links">
        <router-link to="/dashboard-lab" class="nav-link" :class="{ active: $route.path === '/dashboard-lab' }">
        ...
        <router-link to="/notifications-lab" class="nav-link" :class="{ active: $route.path === '/notifications-lab' }">
          <div class="icon-container">
        ...
        <router-link to="/calendar-lab" class="nav-link" :class="{ active: $route.path === '/calendar-lab' }">
          <div class="icon-container">
            <i class="fas fa-calendar"></i>
          </div>
          <span v-show="isExpanded">Bookings</span>
        </router-link>
  
        <router-link to="/user-profile-lab" class="nav-link" :class="{ active: $route.path === '/user-profile-lab' }">
          <div class="icon-container">
